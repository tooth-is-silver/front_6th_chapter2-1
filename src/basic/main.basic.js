    ...
    <div class="mb-6">
      ...
      <div class="space-y-3">
        <div class="bg-gray-100 rounded-lg p-3">
          ...
          // dicount 수치를 * 100해주는 함수 선언 필요
            • 키보드 10개↑: ${DISCOUNT_RATES.KEYBOARD * 100}%<br>
            • 마우스 10개↑: ${DISCOUNT_RATES.MOUSE * 100}%<br>
            • 모니터암 10개↑: ${DISCOUNT_RATES.MONITOR_ARM * 100}%<br>
            • 스피커 10개↑: ${DISCOUNT_RATES.SPEAKER * 100}%
          </p>
        </div>
        <div class="bg-gray-100 rounded-lg p-3">
          <p class="font-semibold text-sm mb-1">전체 수량</p>
          <p class="text-gray-700 text-xs pl-2">• 30개 이상: ${
            DISCOUNT_RATES.BULK_DISCOUNT * 100
          }%</p>
        </div>
        <div class="bg-gray-100 rounded-lg p-3">
    ...
    <div class="mb-6">
      ...
      <div class="space-y-3">
        <div class="bg-gray-100 rounded-lg p-3">
          ...
          <p class="text-gray-700 text-xs pl-2">• 구매액의 ${
