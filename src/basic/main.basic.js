...
main();
setupAddToCartHandler(addBtn, sel, cartDisp, prodList, handleCalculateCartStuffWrapper);
setupCartItemHandler(cartDisp, prodList, handleCalculateCartStuffWrapper, onUpdateSelectOptions);
